...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Lucas M Krolow";
    private static final String CONTACT_GITHUB = "https://gtihub.com/lucasmkrolow";
    private static final String CONTACT_EMAIL = "lucaskrolowcba@@gmail.com";
